...
const button2 = document.getElementById("buttonBase");
const popup = document.getElementById("diaCifra");
const popup2 = document.getElementById("diaBase64");
const fecharModal = document.getElementById("fecharModal");
const fecharModalBase = document.getElementById("fecharBase");
...
fecharModalBase.onclick = function(){
    popup2.close()
}
